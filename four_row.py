...
# Set up sounds
pygame.mixer.init()
gameOverSound = pygame.mixer.Sound('fatality.wav')
pygame.mixer.music.load('mortalkombat.wav')
...
def main():
    ...
    REDTOKENIMG = pygame.image.load('mkred.png')
    REDTOKENIMG = pygame.transform.smoothscale(REDTOKENIMG, (SPACESIZE, SPACESIZE))
    BLACKTOKENIMG = pygame.image.load('mkblue.png')
    BLACKTOKENIMG = pygame.transform.smoothscale(BLACKTOKENIMG, (SPACESIZE, SPACESIZE))
    BOARDIMG = pygame.image.load('4row_board.png')
    BOARDIMG = pygame.transform.smoothscale(BOARDIMG, (SPACESIZE, SPACESIZE))

    HUMANWINNERIMG = pygame.image.load('fatality.png')
    COMPUTERWINNERIMG = pygame.image.load('fatality.png')
